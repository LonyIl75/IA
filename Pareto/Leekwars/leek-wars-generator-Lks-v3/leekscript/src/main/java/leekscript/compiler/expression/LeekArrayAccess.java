...
public class LeekArrayAccess extends Expression {
	...
	public void compileSet(MainLeekBlock mainblock, JavaWriter writer, Expression expr) {
		if( !(mLeftValue && !mTabular.nullable())){
			System.out.println("mLeftValue : " + mLeftValue);
		}
		//assert(mLeftValue && !mTabular.nullable()); //Pb sur    actual_map[getCellY(obs)][getCellX(obs)] = 1;
	...
	public boolean nullable() {
		return true; //pourquoi toujours TRUE ? 
	}
