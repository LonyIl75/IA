...
public abstract class Entity {
	...
	static Stat<enumCaracteristique , StatCaracteristique> stats_total =  new Stat<enumCaracteristique , StatCaracteristique>(StatCaracteristique.provider_statCara,false) ;
	static Stat<enumCaracteristique , StatCaracteristique> stats_atm =  new Stat<enumCaracteristique , StatCaracteristique>(StatCaracteristique.provider_statCara,false) ;
	
	double [] arr_buff_atm =  stats_atm. getDefaultStatTab() ;
	MySet isAffected =  stats_atm.getInitSet();


	public double[][] getStats(){
		
		double [] arr_total = stats_total. getDefaultStatTab() ;

		for ( Integer kid : mBaseStats.stats.keySet()){
			arr_total[ kid ] = mBaseStats.stats.get(kid) ;
		}

		return new double[][]{arr_total,arr_buff_atm };
