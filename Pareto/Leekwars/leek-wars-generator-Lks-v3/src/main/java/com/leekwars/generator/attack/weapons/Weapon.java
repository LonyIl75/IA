...
public class Weapon {
	...
	public static int df_index_Weapon() {
		return Weapons.getTemplates().keySet().iterator().next();
	}
	public static Weapon df_Weapon() {
		return Weapons.getWeapon( df_index_Weapon());
	}
