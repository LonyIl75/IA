...
public class Scenario {
	...
	public Scenario (Scenario _bis ){
		this.seed = _bis.seed;
		this.maxTurns = _bis.maxTurns;
		this.type = _bis.type;
		this.context = _bis.context;
		this.fightID = _bis.fightID;
		this.farmers = _bis.farmers;
		this.teams = _bis.teams;
		this.entities = _bis.entities;
		this.map = _bis.map;
		this.drawCheckLife = _bis.drawCheckLife;
	}
	public static Scenario fromFile( File file ) {
		return fromFile(file, new HashMap<String, JSONObject>());
	}
    public static Scenario fromFile(File file , HashMap<String , JSONObject> _map ) {
