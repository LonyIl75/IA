...
public class Attack {
	...
	public final static int[] type_item = {TYPE_WEAPON,TYPE_CHIP} ; 
	...
	public String toString(){
		return "Attack: minRange: " + minRange + " maxRange: " + maxRange + " los: " + los + " launchType: " + launchType + " area: " + area + " healAttack: " + healAttack + " dammageAttack: " + dammageAttack + " attackType: " + attackType + " itemID: " + itemID + " areaID: " + areaID + " effects: " + effects;
	}
